<div class="list">
    ...
    <div class="lists d-flex align-items-center rounded p-3 mb-5">
        ...
        <div class="name">
            <div>
                ...
                <div class="d-flex justify-content-between me-4 my-2">
                    <small class="text-primary"><i class="fas fa-check"></i> Diverifikasi Pada: <span class="text-primaries fw-bold">{{ date('l, j-M-Y',strtotime($history->diverifikasi)) }}</span></small>
        ...
        <div class="status">
            <button class="buttonbro d-block w-100 rounded fw-bold "><i class="fas fa-check"></i> Transaksi Telah Diselesaikan</button>
            <hr>
